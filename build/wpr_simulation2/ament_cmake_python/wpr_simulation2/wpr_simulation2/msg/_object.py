...
class Metaclass_Object(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('wpr_simulation2')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'wpr_simulation2.msg.Object')
            logger.debug(
...
class Object(metaclass=Metaclass_Object):
    ...
    def __init__(self, **kwargs):
        ...
        self.probability = array.array('d', kwargs.get('probability', []))
    ...
    def probability(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'probability' array.array() must have the type code of 'd'"
        ...
        self._probability = array.array('d', value)
